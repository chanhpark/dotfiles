...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/Users/cxp/.rbenv/versions/2.2.2")
  ...
  CONFIG["configure_args"] = " '--prefix=/Users/cxp/.rbenv/versions/2.2.2' '--with-openssl-dir=/usr/local/opt/openssl' '--with-readline-dir=/usr/local/opt/readline' 'CC=clang' 'CFLAGS= -O3 -Wno-error=shorten-64-to-32 ' 'LDFLAGS=-L/Users/cxp/.rbenv/versions/2.2.2/lib ' 'CPPFLAGS=-I/Users/cxp/.rbenv/versions/2.2.2/include '"
  ...
  CONFIG["RUBY_EXEC_PREFIX"] = "/Users/cxp/.rbenv/versions/2.2.2"
  ...
  CONFIG["OBJEXT"] = "o"
  CONFIG["CPPFLAGS"] = "-I/Users/cxp/.rbenv/versions/2.2.2/include  -D_XOPEN_SOURCE -D_DARWIN_C_SOURCE -D_DARWIN_UNLIMITED_SELECT -D_REENTRANT $(DEFS) $(cppflags)"
  CONFIG["LDFLAGS"] = "-L. -L/Users/cxp/.rbenv/versions/2.2.2/lib  -fstack-protector"
